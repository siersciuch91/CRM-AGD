...
namespace CRM_AGD.Areas.Address.Controllers
{
    [Area("Address")]
    [Authorize]
    public class StreetPrefixesController : Controller, IStreetPrefixesController
    {
        private readonly ApplicationDbContext _context;

        public StreetPrefixesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.StreetPrefixes.OrderBy(s => s.Prefix).ToListAsync());
        }
