...
namespace CRM_AGD.Areas.Client.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        {
            ViewData["StreetId"] = new SelectList(_context.Streets, "StreetId", "Description");
            var context = _context.Client.Include(c => c.street).Include(c => c.street.streetPrefix).Include(c => c.street.city).SingleOrDefault();
            return View(context);
        }
        ...
        public async Task<IActionResult> Create([Bind("ClientId,FirstName,SecondName,EmailAddress,PhoneNumber,StreetId,HomeNumber")] CRM_AGD.Areas.Client.Models.Client client)
        {
            ...
            ViewData["StreetId"] = new SelectList(_context.Streets, "StreetId", "Description", client.StreetId);
            return View(client);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["StreetId"] = new SelectList(_context.Streets, "StreetId", "FullName", client.StreetId);
            return View(client);
        }
        ...
        public bool ClientWithEmailExists(string email)
        {
            return _context.Client.Any(e => e.EmailAddress == email);
        }
    }
}
